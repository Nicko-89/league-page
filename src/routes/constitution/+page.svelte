...
<div class="constitution">
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(one)}>Section 1: Basics</h3>
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(two)}>Section 2: Drafting</h3>
        ...
        <h4 class="noUnderscore clickable" on:click={() => goToSection(twoThree)}>2.2 Draft Day Trades</h4>
    ...
    <div class="subBlock">
        <p>Trade rape/unbalanced trades are not kosher however they are not forbidden under the rules. Draft picks can be traded and the value of picks or fairness of trades are determined by the parties involved. Only clear collusion will be barred. </p>
    </div>
    
    <h4 bind:this={oneTwoFive}>1.2.5 Veto/Trade Process</h4>
    <div class="subBlock">
        <p>Commish holds veto rights however no trade is to be veto’d unless there is clear collusion that is agreed by a league majority. </p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $300. $0 bids are allowed. Bids will process Wednesday at 5pm.</p>
    ...
    <p>The draft order each year will be a snake draft order determined by a novelity method of the leagues choosing.</p>
    ...
    <p>When a manager needs to be replaced, the comissioners will try to find a suitable candidate with some connection to at least a portion of the existing managers. Priority will be placed on managers who are eager and will be very active within the league.</p>
    ...
    <p>League dues are set at {dues}$. All managers must be fully paid up before the start of regular season. In the event that a manager fails to pay before the deadline, a 10% penalty will be addd to their payment and will go towards the payouts at the end of the year.</p>
    
    <h3 bind:this={sevenTwo}>7.2 Prizes</h3>
    <p>Prizes are detailed in the league ledger and will be reviewed each season based on available funds. Prizes will be purchased based on league members favorite NFL team as recorded in the league ledger or based on the worst actual NFL team + player for that season there may be variation in type or prize based on cost and availability that season. (League champion can select a jersey for a player on their fantasy squad not just their favorite team.) </p>

    <p>The overall loser must display their loser trophy on their Facebook profile picture and cover photo the following season. </p>
